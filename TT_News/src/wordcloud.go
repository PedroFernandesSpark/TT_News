...
var path = flag.String("input", "src/wordcloud/input.json", "path to flat JSON like {\"word\":42,...}")
var config = flag.String("config", "src/wordcloud/config.json", "path to config file")
var output = flag.String("output", "output.png", "path to output image")
var cpuprofile = flag.String("cpuprofile", "src/wordcloud/profile", "write cpu profile to file")
...
var DefaultConf = Conf{
	...
	FontFile:        "./wordcloud/fonts/roboto/Roboto-Regular.ttf",
